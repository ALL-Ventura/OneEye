    ...
    def parse(self):     
        ...
        for command in self.data:
            ...
            if command == SYMBOLS_CMD:
                work_data = pd.DataFrame(work_data["returnData"]) 
...
with open("xtb_allData.json", "w") as save_file:
    json.dump(api.data, save_file, indent=4)

api.trades.to_excel("xtb_trades.xlsx")
api.margin.to_excel("xtb_margin.xlsx")
api.symbols.to_csv("xtb_symbols.csv")

# Output stored in /sample data
